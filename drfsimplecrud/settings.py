...
TEMPLATES_DIR = os.path.join(BASE_DIR, 'templates')  # Ruta para plantillas
STATICFILES_DIR = os.path.join(BASE_DIR, 'static')    # Ruta para archivos estáticos (CSS, JS, imágenes)
...
STATIC_URL = '/static/'  # Esta es la URL pública para acceder a los archivos estáticos
...
STATICFILES_DIRS = [
    STATICFILES_DIR,  # Solo incluye la carpeta de archivos estáticos (no plantillas)
]
